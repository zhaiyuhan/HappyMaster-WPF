    ...
    class LyricShow
    {
        ...
        public static void initializeLyricUI(SortedDictionary<Double, string> TimeAndLyricDictionary)
        {
            ...
            foreach (string txt in TimeAndLyricDictionary.Values)
            {
                ...
                /*byte[] defBytes = System.Text.Encoding.Default.GetBytes(txt);
                byte[] utf8Bytes = System.Text.Encoding.Convert(System.Text.Encoding.Default, System.Text.Encoding.UTF8, defBytes);*/
                //tb.Text = System.Text.Encoding.UTF8.GetString(txt);
                tb.Text = txt;
